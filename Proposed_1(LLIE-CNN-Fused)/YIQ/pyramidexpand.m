    ...
    for iRow = 1:heightNext
        for jCol = 1:widthNext
            for iFilter = -radiusFilter:radiusFilter
                ...
                if rowPrevImg ~= floor(rowPrevImg), continue; end
                if rowPrevImg < 1
